...
export default function Page() {
    return (
        <div className="w-full bg-[#FDF4F1] overflow-hidden " >
            <VirtualTourHero/>


            <ChooseTour/>
               <div className="bg-red-600 w-fit py-4 px-5  rounded-r-lg transform translate-x-[-100%]  duration-150 ease-in-out transition-transform " >
