...
export default function RoundTrip() {
    return (
        <section className=" w-full bg-white  max-w-7xl py-12 px-6 shadow-inner rounded-2xl flex gap-10 items-center justify-between h-full " >
            ...
            <div className=" flex flex-col gap-5 items-start " >
                ...
                <div className="w-fit basis-1/3 relative flex items-start gap-3 justify-start border border-[#E6E8E7] py-7 px-4 rounded-md " >
                    ...
                    <div className="flex flex-col gap-1 items-start" >
                        ...
                        <p className="text-sm md:text-base font-normal">Madras International Meenambakkam Airport</p>
            ...
            <div className=" h-full basis-1/3 flex flex-col items-center justify-between gap-3 " >
                ...
                <Button ariaLabel="Search Flights" label="Search Flights" type="button" variant="primary" className="w-full font-signika !bg-[#EF8F57] text-white !py-4  hover:scale-90 transition-transform duration-150 ease-in-out shadow-2xl " />
            ...
            <div className=" flex flex-col gap-5 items-start " >
                ...
                <div className="w-fit basis-1/3 relative flex items-start gap-3 justify-start border border-[#E6E8E7] py-7 px-4 rounded-md " >
                    ...
                    <span className="absolute top-[-15px] left-10 text-xs md:text-sm font-normal block bg-white p-2 " >Return</span>
                </div>
