...
export default function ReadyToNavigate() {
    ...
    return (
        <div className=" w-full h-fit py-32 px-[6%] flex flex-col items-center justify-center gap-6 text-white bg-gradient-to-br from-[#D4422C] to-[#A33323] text-center relative ctaSection        "  >
            ...
            <Link href={"/street-rhythm-2/#hero"} className=" bg-white py-3 md:py-5 px-7 md:px-10 text-[#D4422C] font-semibold text-sm md:text-xl rounded-lg cursor-pointer hover:-translate-y-2 transition-all duration-300 ease-in-out hover:shadow-2xl flex items-center justify-center gap-2  " >
                Start Your Journey
                <ArrowRight size={23} />
            </Link>
